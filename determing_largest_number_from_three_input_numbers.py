...
# make GUI components (button, entry fields, and labels).
    ...
    input_number1_label = Ctk.CTkLabel(frame, text="1st input:", width=10)
    input_number1_label.place(relx=0.2, rely=0.3, anchor= "center")
    input_number1_entry = Ctk.CTkEntry(frame )
    input_number1_entry .place(relx=0.4, rely=0.3, anchor="center")

    input_number2_label = Ctk.CTkLabel(frame, text="2nd input:", width=10)
    input_number2_label.place(relx=0.2, rely=0.4, anchor= "center")
    input_number2_entry = Ctk.CTkEntry(frame )
    input_number2_entry .place(relx=0.4, rely=0.4, anchor="center")

    input_number3_label = Ctk.CTkLabel(frame, text="3rd input:", width=10)
    input_number3_label.place(relx=0.2, rely=0.5, anchor= "center")
    input_number3_entry = Ctk.CTkEntry(frame )
    input_number3_entry .place(relx=0.4, rely=0.5, anchor="center")
    ...
    result_label = Ctk.CTkLabel(frame, text="The greatest number is  . ", width=20)
